...
// @grant          none
// @version        v1.4001
// @description    Adds external links section to MU's series info page, with Anime-Planet, MAL, MangaDex, MangaFox, MangaHere, KissManga, MangaPark, DynastyScans and AniDB.
// ==/UserScript==
...
var table = getElementByClassName("div", "sCat").children[0];
...
pageAdressBeginning.push("https://mangapark.me/search?q=");
searchName.push(encodeURIComponent(title));
pageAdressEnding.push("");
